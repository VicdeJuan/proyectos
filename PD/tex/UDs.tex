...
%
%
%F. UNIDADES DE TRABAJO (= UNIDADES DIDÁCTICAS)
%	 Se incluyen las UNIDADES DE TRABAJO (UT) diseñadas que deberían incluir:
%		 Resultado/s de Aprendizaje que se trabajan.
%		 Actividades de enseñanza-aprendizaje.
%		 Contenidos: Deben estar coherentemente secuenciados: tener en cuenta la situación de partida del alumno, pero garantizar los conocimientos necesarios imprescindibles para cursar el siguiente bloque de contenidos en caso de que haya continuidad.
%		 Actividades de evaluación.
%		 Criterios de evaluación.
%		 Procedimientos de evaluación asociados a los criterios de evaluación.
%		 Instrumentos de calificación asociados a los procedimientos de evaluación.
%		 Criterios de calificación para los RA trabajados.
%	 También pueden incluir:
%		 Metodología de la UT/de las actividades
